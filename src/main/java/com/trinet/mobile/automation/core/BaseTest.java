...
import com.trinet.mobile.automation.core.Configuration;
import com.trinet.mobile.automation.core.Constants;
...
//		startAppiumServer();
	...
	//	capabilities.setCapability(Constants.APP_PACKAGE, configuration.getProperty(Constants.APP_PACKAGE));
	//	capabilities.setCapability(Constants.APP_ACTIVITY, configuration.getProperty(Constants.APP_ACTIVITY));
...
//		capabilities.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT, 8000);
		...
		//driver = new AndroidDriver(new URL(service.getUrl(), urlString), capabilities);
...
//Kill the driver After each 'suite file' in TestNGsuite.xml  
//	@AfterClass
...
//		if (actualMessage.equals("Dashboard")){
